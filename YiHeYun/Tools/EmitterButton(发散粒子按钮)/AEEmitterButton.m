...
@implementation AEEmitterButton

/**
 *  通过fram初始化
 *
 *  @param frame AEEmitterButton的fram
 *
 *  @return 返回AEEmitterButton对象
 */
...
- (void)setup {
    ...
    _explosionLayer.position      = CGPointMake(self.width/2, self.height/2);
