...
#pragma mark - 图片长按手势监听
- (void)longPress:(UILongPressGestureRecognizer *)longPress {
    if ([self.i_delegate respondsToSelector:@selector(longPressImageViewTappedWithObject:)])
    {
        [self.i_delegate longPressImageViewTappedWithObject:self];
    }
}
